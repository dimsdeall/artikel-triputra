...
@section('title', 'Operator2 | Indigo')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#editmodal', function() {
            ...
            $('#form_modal').attr('action', '/indigo/' + $(this).data('id'));

            nb($(this).data('idsacon'), $(this).data('idwarping'));
        });

        $(document).on('click', '#btnprint', function() {
            // alert('asd');   
            $('#idbarcode').val($(this).data('sacon'));
        ...
        $(document).on('click', '#delete', function() {
            $('#form_delete').attr('action', '/indigo/' + $(this).data('id'));
        });
...
@section('content')
    <div class="col-md-12 col-sm-12 pt-2">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title text-white">Data Indigo</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if ($errors->any())
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalheader">Edit Indigo</h4>
                </div>
                    ...
                    <form id="form_modal" method="POST" action="" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>MC IDG</label>
                                    <input type="text" id="mc_idg" name="mc_idg" class="form-control"
                                        style="text-transform: uppercase" value="{{ old('mc_idg') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Warna</label>
                                    <input type="text" id="w" name="w" class="form-control"
                                        style="text-transform: uppercase" value="{{ old('w') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
    ...
    <form method="POST" id="printbarcode" action="/operator2/barcode/indigo" target="_blank">
        {{ csrf_field() }}
        <input type="hidden" name="idbarcode" id="idbarcode">
    </form>

    <form action="/indigo/export/excel" id="form_export" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
    ...
    <script type="text/javascript">
        ...
        function nb(idsacon, idwarping) {
            $.ajax({
                type: 'POST',
                url: '/indigo/operator2/getnb',
                data: {
                    _token: "{{ csrf_token() }}",
                    sacon: idsacon,
                    warping: idwarping
                ...
                success: function(data) {
                    document.getElementById('warping_id').innerHTML = data;
                },
                error: function(xhr) {
